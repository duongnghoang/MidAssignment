...
namespace Infrastructure.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "BookBorrowingRequestsDetail",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookBorrowingRequestsDetail", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookBorrowingRequestsDetail_BookBorrowingRequests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "BookBorrowingRequests",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BookBorrowingRequestsDetail_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookBorrowingRequestsDetail_BookId_RequestId",
                table: "BookBorrowingRequestsDetail",
                columns: new[] { "BookId", "RequestId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BookBorrowingRequestsDetail_RequestId",
                table: "BookBorrowingRequestsDetail",
                column: "RequestId");
